...
import { ScheduledauditsRoutingModule } from './scheduledaudits-routing.module';
...
@NgModule({
  declarations: [
    ListScheduledauditsComponent,
    AddScheduldauitsComponent,
    ScheduledViewComponent
  ],
  imports: [
    CommonModule,
    ScheduledauditsRoutingModule,
    CommonModule,
