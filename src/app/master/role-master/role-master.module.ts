...
import { DeleteRoleMasterComponent } from './list-role-master/delete-role-master/delete-role-master.component';
...
@NgModule({
  declarations: [
    ...
    ListRoleMasterComponent,
    DeleteRoleMasterComponent
  ],
  providers: [
    NotificationService
  ],
