...
import { DeleteDepreciationComponent } from './list-depreciation/delete-depreciation/delete-depreciation.component';
...
@NgModule({
  declarations: [
    AddDepreciationComponent,
    ListDepreciationComponent,
    DeleteDepreciationComponent
  ],
  imports: [
    CommonModule,
