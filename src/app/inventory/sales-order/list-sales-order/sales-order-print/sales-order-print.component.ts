...
@Component({
  ...
  styleUrls: ['./sales-order-print.component.sass']
})
export class SalesOrderPrintComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.docForm.patchValue({
      'salesNo':sessionStorage.getItem("salesNo"),
      'customerName':sessionStorage.getItem("customerName"),
      'currency':sessionStorage.getItem("currency")
    })

    this.exampleDatabase=this.docForm.value;
    this.httpService.get(this.salesOrderService.getList, this.exampleDatabase).subscribe((res: any) => {
      this.beanValue=res.salesOrderList;
    });
  }
