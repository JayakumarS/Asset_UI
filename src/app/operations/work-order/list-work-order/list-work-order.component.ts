...
import { DeleteWorkOrderComponent } from './delete-work-order/delete-work-order.component';


@Component({
  selector: 'app-list-work-order',
  templateUrl: './list-work-order.component.html',
  styleUrls: ['./list-work-order.component.sass']
})

export class ListWorkOrderComponent  extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    "workorderNo",
    "workorderDate", "bomNo", "booNo", "salesOrderNo",
    "actions"
  ];
